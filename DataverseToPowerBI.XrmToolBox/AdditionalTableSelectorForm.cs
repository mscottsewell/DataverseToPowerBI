...
namespace DataverseToPowerBI.XrmToolBox
{
    ...
    public class AdditionalTableSelectorForm : Form
    {
        ...
        /// <param name="currentAdditionalRelationships">Previously defined manual relationships (for edit scenarios).</param>
        ...
        private void InitializeComponent()
        {
            ...
            {
                Text = "Manual Relationships (optional):",
                Font = _boldFont,
            ...
            {
                Text = "Define many-to-one relationships between selected tables and existing model tables. " +
